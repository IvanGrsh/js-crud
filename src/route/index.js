...
router.post('/purchase-create', function (req, res) {
  ...
  res.render('purchase-create', {
    ...
    data: {
      ...
      cart: [
        {
          text: `${product.title} (${amount} amount)`,
          price: productPrice,
        },
...
router.post('/purchase-submit', function (req, res) {
  ...
  if (product.amount < amount) {
    return res.render('purchase-alert', {
      ...
      data: {
        message: 'Error',
        info: 'Dont have a lot of product',
        link: `/purchase-list`,
      },
    })
  }
  ...
  if (!firstname || !lastname || !email || !phone) {
    return res.render('purchase-alert', {
      ...
      data: {
        message: 'Fill in the important fields',
        info: 'Incorrect info',
        link: `/purchase-list`,
      },
    })
...
router.get('/purchase-info', function (req, res) {
  ...
  res.render('purchase-info', {
    ...
    data: {
      ...
      totalPrice: purchase.phototalPricene,
...
router.get('/purchase-modify', function (req, res) {
  ...
  if (!purchase) {
    res.render('purchase-alert', {
      ...
      data: {
        message: 'Error',
        info: 'Order with this ID was not found',
        href: `/`,
      },
    })
  } else {
